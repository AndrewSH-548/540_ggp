...
void Game::Initialize()
{
	...
	CreateWICTextureFromFile(Graphics::Device.Get(), Graphics::Context.Get(), FixPath(L"../../Assets/Textures/cushion.png").c_str(), 0, &cushionTexture);
	CreateWICTextureFromFile(Graphics::Device.Get(), Graphics::Context.Get(), FixPath(L"../../Assets/Textures/cushion_normals.png").c_str(), 0, &cushionNormal);

	textures.insert({ "CushionTexture", cushionTexture });
	textures.insert({ "NormalMap", cushionNormal });
